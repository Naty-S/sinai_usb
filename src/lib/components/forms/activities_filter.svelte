...
<div class="ui container center aligned segment">
  ...
  <div class="two inline fields">
    <Input
      ...
      customHandleChange={(e) => {handleChange(e); $form.date_end = date_end}}
    ...
    <Input
      ...
      customHandleChange={(e) => {handleChange(e); $form.date_start = date_start}}
    ...
    {#each kinds as kind}
      <div class="column">
        <Input
          ...
          customHandleChange={(e) => {handleChange(e); $form.date_start = date_start; $form.date_end = date_end}}
          error={$errors[kind]}
          class="field"
        />
      </div>
